    ...
    <div class="container cont">
      ...
      <div class="row justify-content-center">
         ...
         <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card">
            <div class="card-header title">Add blood group available in your bloodbank</div>
        <div class="card-body">
        <form action="file/infoAdd2.php" method="post">
...
<?php   if(isset($_SESSION['bcid'])){
    $bcid=$_SESSION['bcid'];
    $sql = "select * from bloodinfo2 where bcid='$bcid'";
    ...
    <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <table class="table table-striped table-responsive">
            ...
            <tr>
              ...
              <td><a href="file/delete2.php?bid=<?php echo $row['bid'];?>" class="btn btn-danger">Delete</a></td>
            </tr>
            <?php } ?>
          </table>
      </div>
