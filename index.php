        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <i class="fa fa-envelope"> </i> <a > nishantingawale13@gmail.com</a><br>
                        <i class="fa fa-envelope"> </i> <a > akshatajathar@gmail.com</a><br>
                        <i class="fa fa-envelope"> </i> <a > girirajgurav@gmail.com</a><br>
                        
                        <i class="fa fa-mobile"> </i> <a > +91 9359248942</a><br><br>
                    </div>
                </div>
            </div>
            </div>
